...
2. Using the *IBM Watson Machine Learning Dashboard*, add the model location by providing the sample *ProjectID* named *WatsonMachineLearningSampleProject*. Now you should see the model *CustomerSatisfactionPrediction* in the list of available models.
